 ...
 * @author dyasonfra
 */
public class AddCosts extends javax.swing.JFrame {

    /**
     * Creates new form AddCosts
     */
    public AddCosts() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCosts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
